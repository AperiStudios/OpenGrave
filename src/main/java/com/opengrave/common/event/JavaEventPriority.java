...
public class JavaEventPriority {

	private EventHandlerPriority priority;
	private Class<? extends Event> eventClass;

	public JavaEventPriority(Class<? extends Event> eventClass, EventHandlerPriority priority) {
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		JavaEventPriority other = (JavaEventPriority) obj;
		if (eventClass == null) {
