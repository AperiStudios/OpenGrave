...
public class XMLReturnedEvent extends Event {

	private Document returnedXML;
	private String documentOriginal;

	public XMLReturnedEvent(Document returnedXML, String documentOriginal) {
