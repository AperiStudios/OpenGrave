...
public class ObjectsDespawnPacket extends Packet {
	public ArrayList<UUID> idList = new ArrayList<UUID>();

	@Override
	public void send(OGOutputStream stream) throws IOException {
		stream.writeInt(idList.size());
	...
	public void recieve(OGInputStream stream) throws IOException {
		...
		for (int c = 0; c < i; c++) {
			idList.add(stream.readUUID());
		}
	}

	@Override
	public String getEventName() {
		return "objectsdespawnpacket";
	}
