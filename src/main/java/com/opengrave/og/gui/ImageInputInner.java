...
public class ImageInputInner extends Image {

	public static Texture textureStatic;
	private int fy;
	private int fx;

	public ImageInputInner(ElementData ed) {
		super(ed);
		this.texture = textureStatic;
	}

	public void setForcedDimensions(int x, int y) {
		fx = x;
		fy = y;
	}
